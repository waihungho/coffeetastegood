...
char buf[50];
#define READ_INTERVAL 10000 // the intervals to read from PMS3003 (5s)
#define PMS3003_DISPLAY_DURATION 10000   
// PMS3003 Configuration (BEGIN)

// DHT 溫度和濕度 Configuration (BEGIN)
#include <dht.h>   
#define DHT_PIN 2 //定義訊號要從Pin 2 進來  
#define DHT_INIT_WAIT 1000 //定義訊號要從Pin 2 進來  
#define DHT_DISPLAY_DURATION 10000 
dht DHT;   
// DHT Configuration (BEGIN)

void setup() {
  Serial.begin(9600);
  Serial1.begin(9600);  // Pin 19 (Blue) --> PMS3003

  // initialize the LCD
  lcd.begin();
  // Turn on the blacklight and print a message.
  lcd.backlight();
  displayLED("Welcome!", "Loading......");
