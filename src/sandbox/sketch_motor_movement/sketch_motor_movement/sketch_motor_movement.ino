...
{ 
 ...
 //   LEFT   RIGHT
  ...
  myservo.attach(9, 500, 2400); // 修正脈衝寬度範圍  LEFT servo
  myservo2.attach(4, 500, 2400); // 修正脈衝寬度範圍 RIGHT servo
...
// 2100 --> 1500 --> 900
 ...
 const int REVIEW_SEC = 3000;
 const int RUN_SEC = 30;
 int delaySec = RUN_SEC;
void go2Center(){
...
void loop() 
{
 ...
 if (mode==1) {
  ...
  go2Bottom();
     ...
     const int DELAY_SEC = 150;
    int delayInterval = DELAY_SEC;
...
//    int rightServoTo2[MOVE_TO_ARRAY_SIZE_2] = {2000, 2000, 1900, 1800, 1700, 1600, 1500 };
    ...
    int leftServoTo2[MOVE_TO_ARRAY_SIZE_2] =  {2000, 1900, 1800, 1700, 1600, 1500 };  //Left to Top
    int rightServoTo2[MOVE_TO_ARRAY_SIZE_2] = {2000, 1900, 1800, 1700, 1600, 1500 };
    ...
    #define MOVE_TO_ARRAY_SIZE_4 10
//    int leftServoTo4[MOVE_TO_ARRAY_SIZE_4] =  {1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000};  //Right to Bottom
//    int rightServoTo4[MOVE_TO_ARRAY_SIZE_4] = {900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 };s

        int leftServoTo4[MOVE_TO_ARRAY_SIZE_4] =  {1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000};  //Right to Bottom
    int rightServoTo4[MOVE_TO_ARRAY_SIZE_4] = { 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 , 900 };
    
    for(int i = 0; i < MOVE_TO_ARRAY_SIZE_4 ; i++){ 
      Serial.println("Right to Bottom[i]" + String(i) + "[leftServo]" +  String(leftServoTo4[i]) + "[rightServo]" +  String(rightServoTo4[i]));
  ...
  digitalWrite(relayPin, LOW);  // Power OFF
  delay(10000);
